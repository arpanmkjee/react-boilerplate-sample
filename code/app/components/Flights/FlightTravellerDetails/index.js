                            ...
                            <div class="tvlr-row" id="wrapper_ADULT">
                                <div class="tvlrDtls-header">
                                    <p class="make_flex space_between alC">
                                        ...
                                        </span><span class="font16 LatoMedium text-green">{this.state.selectedCount} selected</span>
                                    </p>
                                </div>
                                <div class="paddLR15">
                                    {this.state.warning ? <p style={{ color: "red" }} class="hideMe">You have already selected 1 ADULT. Remove before adding a new one.</p> : null}
                                    {this.state.openAddAdult ? <p class="tvlr-sctn tvlrDtls-heading font20"> You have not added any adults to the list</p> :

                                        <div class="tvlr-sctn append_bottom15 make_relative" id="MANUAL_d17e2512-433e-455e-a4cf-45d6a19b2ae2">
                                            <div class="tvlrDtls-heading make_relative">
                                                <div class="make_flex alC">
                                                    <p class="tvlrDtls-heading-txt checkbox-group"><input type="checkbox"
                                                ...
                                                <div class="nameCnf-overlay-sctn">
                                                    ...
                                                    <div class="make_flex">
                                                        ...
                                                        <div class="nameCnf-overlay-col nameCnf-cta">
                                                            <p><a class="btn fli_primary_btn text-uppercase continue_cta" href="javascript:void(0)">Done</a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                </p><a href="javascript:void(0);" style={{ cursor: "pointer" }}
                                    class="font14 LatoBold text-uppercase paddLR15" onClick={this.OpenAddAdult} >+ ADD ADULT</a>
                            </div>
