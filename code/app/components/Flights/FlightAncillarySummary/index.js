...
class FlightAncillarySummary extends React.Component {
  constructor(props){
    super(props);
    this.state={
        fare:this.props
      ...
      <div>
        ...
        <div class="tvlr-sctn append_bottom15">
          <div class="tvlrDtls-heading">
            ...
            <div>
              <p class="tvlrDtls-heading-txt LatoBold append_bottom5">{this.state.fare.fareSummary.title}</p>
              <p class="font18">
                <font color="#4a4a4a">Departure Sat, 16 Nov</font>
              </p>
            </div>
            
            <a href="javascript:void(0);" class="tvlrCollapseble LatoMedium">
              Flight
