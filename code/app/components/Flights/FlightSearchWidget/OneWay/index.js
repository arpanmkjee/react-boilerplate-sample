  ...
  return (
    ...
    <div class="fsw_inner ">
        <div class="fsw_inputBox searchCity inactiveWidget "><label for="fromCity"><span
                ...
                <p class="code makeRelative" title="DEL, Delhi Airport India"><span data-cy="defaultFromValue"
        ...
        <div class="fsw_inputBox searchToCity inactiveWidget "><label for="toCity"><span
                ...
                <p class="code makeRelative" title="BLR, Kempegowda International Airport India"><span
                        data-cy="defaultToValue" class="truncate airPortName">BLR, Kempegowda International Airport
                        India</span></p>
            </label></div>
        ...
        <div class="fsw_inputBox dates reDates inactiveWidget ">
            <div data-cy="returnArea"><label><span class="lbl_input latoBold appendBottom10">RETURN</span>
                    <p data-cy="returnDefaultText" class="latoBlack greyText">Tap to add a return date for bigger
                        discounts</p>
                </label></div>
        </div>
        <div data-cy="flightTraveller" class="fsw_inputBox flightTravllers inactiveWidget "><label
                ...
                <p data-cy="travellerText" class="blackText font20 code"><span class="appendRight10"><span
